...
export default function Card({ question, options, checkAnswer, optionClicked, handleNextBtnClick }) {
    return (
        <div className='quiz-card'>
            ...
            {options.sort().map((item, index) => {
                const alph = ["A", "B", "C", "D"]
                return <div key={index} className='options' onClick={()=>checkAnswer(item)} >
